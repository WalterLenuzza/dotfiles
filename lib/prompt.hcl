...
file.content "bash_prompt" {
  depends     = ["file.directory.config"]
  destination = "{{param `prefix`}}/.config/bash/prompt"
...
function __promptline {
  ...
  local b_bg="${wrap}48;5;142${end_wrap}"
  local b_sep_fg="${wrap}38;5;142${end_wrap}"
  local c_fg="${wrap}38;5;235${end_wrap}"
  local c_bg="${wrap}48;5;214${end_wrap}"
  local c_sep_fg="${wrap}38;5;214${end_wrap}"
  local warn_fg="${wrap}38;5;235${end_wrap}"
  local warn_bg="${wrap}48;5;167${end_wrap}"
  local warn_sep_fg="${wrap}38;5;167${end_wrap}"
  local x_fg="${wrap}38;5;235${end_wrap}"
  local x_bg="${wrap}48;5;208${end_wrap}"
  local x_sep_fg="${wrap}38;5;208${end_wrap}"
  if [[ -n ${ZSH_VERSION-} ]]; then
